...
<section class="service">
  <div class="container">
    ...
    <div class="row no-gutter">
      ...
      <div class="col-sm-12 grid-two ">
        <div class="row">
        <div class="col-sm-12  rent-img">
          <img src="image/farm-vector.png" class="img-fluid" >
        </div>
        <div class=" grid-two-title ">
          <h4 class="text-center">Book Your <strong class="text-success"> Farm</strong></h4>
        </div>
        </div>
      </div>
      <div class="col-sm-12 grid-two  "></div>
      <div></div>
    </div>
  </div>
</section>
